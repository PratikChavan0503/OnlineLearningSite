...
<body>
        ...
        <div class="section-hero">
            <div class="container grid grid-two--cols">
                <div class="section-hero--content">
                    ...
                    <p class="hero-para">
                        Welcome to EduHub, your gateway to knowledge and skill
                ...
                <div class="section-hero--image">
                    <figure>
                        <img src="./images/main-hero.png" alt="a character learning coursers" />
                    </figure>
                </div>
            </div>
        </div>
        <div class="custom-shape-divider-bottom-1699008188">
    ...
    <section class="section-Why--choose">
        <div class="container">
            ...
            <p class="section-common-subheading">
                Choose EduHub for holistic,enriching learning experience that empowers you to achieve goals.
            </p>
        </div>
        <div class="container grid grid-three--cols">
            <div class="choose-left--div text-align--right">
                ...
                <div class="why-choose--div">
                    ...
                    <h3 class="section-common--title">Life Long Learning Support</h3>
                    <p>
                        Out commitment to your education doesn't end with a certificate.Receive ongoing support and
